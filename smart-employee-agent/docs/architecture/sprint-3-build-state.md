...
**Last updated:** 2026-05-10 — **3B.1 closed end-to-end: D3.2 admin-terminate proven live against WSO2 IS Console terminate. Cascade fully working with rid threaded across all 5 hops.**
**Branch:** `sprint-3-build` @ `5a8e596`.
**Tests:** 877 / 48 files green (per `tools/run-tests.sh`).
