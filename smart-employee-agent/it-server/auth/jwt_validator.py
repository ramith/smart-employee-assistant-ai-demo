...
Mirrors hr-server/auth/jwt_validator.py in shape. Sprint 1 implementation
...
- nested act allowlist: config.TRUSTED_PEER_AGENTS (it-agent + orchestrator-agent)
"""
import logging
...
class JWTValidator:
    ...
    def validate(self, token: str) -> dict:
        raise NotImplementedError(
            "it-server.auth.jwt_validator.JWTValidator.validate — "
