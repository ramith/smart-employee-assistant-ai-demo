...
echo
echo "    Demo queries:"
echo "      employee : \"Where is my cubicle and what laptop do I have?\""
echo "      hr_admin : \"Show me vacant cubicles\"  then  \"Show me floor 2\""
echo "                 then  \"Assign C-027 to jane.doe\""
...
echo "    Manual gate runbook: docs/architecture/sprint-4-stage-11-manual-gate.md"
