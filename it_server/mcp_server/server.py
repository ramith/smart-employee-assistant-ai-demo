...
Mirrors hr_server/mcp_server/server.py shape. Sprint 1 fills in:
...
- Nested act chain check (allowlist: it_agent + orchestrator-agent)
"""
import logging
...
def build_app():
    ...
    """
    mcp = FastMCP(name="it_server", stateless_http=True, json_response=True)
